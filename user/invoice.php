...
<html lang="en">
    ...
    <head>
        <title>View Invoice | Computer Service Management System</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title-box">
                                    <h4 class="font-size-18">View Invoice</h4>
...
$ret=mysqli_query($con,"select distinct tbluser.FullName,tblinvoice.BillingId,tblinvoice.InvoiceDate from  tbluser   
    join tblinvoice on tbluser.ID=tblinvoice.Userid  where tbluser.ID='$uid'");
$cnt=1;
